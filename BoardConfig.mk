...
PRODUCT_COPY_FILES += \
	...
	$(call find-copy-subdir-files,,$(LOCAL_PATH)/prebuilt/vendor-modules, $(TARGET_COPY OUT VENDOR)/11b/modules) \
	$(call find-copy-subdir-files,,$(LOCAL_PATH)/prebuilt/randisk-modules, $(TARGET_COPY_OUT VENDOR_RAMDISK)/lib/modules)
