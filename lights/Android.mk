...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.light@2.0-service.spaced
...
LOCAL_MODULE_PATH := $(TPRODUCT_EXTRA_VNDK_VERSIONS)/vendor_overlay/$(PLATFORM_VNDK_VERSION)/etc/vintf/manifest
